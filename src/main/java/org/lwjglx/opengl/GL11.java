...
public class GL11 {
    ...
    public static void glDrawElements(int mode, int count, int type, java.nio.ByteBuffer indices) {
        ...
        org.lwjgl3.opengl.GL11.glDrawElements(mode, count, type, MemoryUtil.getAddress(indices));
    }
    ...
    public static void glReadPixels(int x, int y, int width, int height, int format, int type,
        ...
        org.lwjgl3.opengl.GL11.glReadPixels(x, y, width, height, format, type, MemoryUtil.getAddress(pixels));
    }
